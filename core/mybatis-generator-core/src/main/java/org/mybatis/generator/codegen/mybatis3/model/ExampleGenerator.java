...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        offSet.setType(FullyQualifiedJavaType.getInteger());
        offSet.setName("offSet"); //$NON-NLS-1$
        commentGenerator.addFieldComment(offSet, introspectedTable);
        topLevelClass.addField(offSet);

        Field length = new Field();
        length.setVisibility(JavaVisibility.PROTECTED);
        length.setType(FullyQualifiedJavaType.getInteger());
        length.setName("length"); //$NON-NLS-1$
        ...
        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setName("setLength"); //$NON-NLS-1$
        method.addParameter(new Parameter(FullyQualifiedJavaType.getInteger(), "length")); //$NON-NLS-1$
        method.addBodyLine("this.length = length;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        ...
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setReturnType(FullyQualifiedJavaType.getInteger());
        method.setName("getLength"); //$NON-NLS-1$
        method.addBodyLine(" return length;"); //$NON-NLS-1$
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
